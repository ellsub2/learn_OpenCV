...
int main(int argc, char *argv[]){
	...
	while(1){
		...
		//TIP: PI*2 = 60分
		int hour   = (short_hand_val + slope)*(12/(PI*2)),
			minuts = (long_hand_val + slope)*(60/(PI*2));
					
		//etc proc=======================================================
		//put time-------------------------
		char daigou[500];
		sprintf(daigou, "「おにぃちゃん?もう%d:%dだよ?? はやく起きてよね!」\tCV:大郷拓也", hour, minuts);
		cout << daigou << endl;
